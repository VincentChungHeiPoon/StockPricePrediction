...
class DataCollection:
    ...
    def get_stock_list_string(filename):
        stock_string = ''
        start_date = ''
        end_date = ''
        try:
    ...
    def get_stock_data(filename):
        start_date, end_date, stock_list_string = DataCollection.get_stock_list_string(filename)
    ...
    def save_data_as_csv(filename, targetFileName):
        data = DataCollection.get_stock_data(filename)
